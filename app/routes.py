...
from app import app
from app.db import get_turniere, get_ergebnistyp, get_runden_pro_spiel_pro_turnier, get_turniername, get_anzahl_teilnehmer_pro_turnier, get_punkte_pro_spiel_pro_turnier, get_spielliste_pro_turnier, get_punkteliste, get_teilnehmerid, add_teilnehmer, get_all_teilnehmer, delete_teilnehmer, add_spiel, get_all_spiele, delete_spiel, get_spiel, create_tables, get_teilgenommene_turniere_pro_teilnehmer
import sqlite3
import os
...
def turnier(turnierid):
	...
	anzahl_teilnehmer = get_anzahl_teilnehmer_pro_turnier(turnierid)
	#punkte statt platz
...
def ergebnis(turnierid, spielname):
	...
	spielid = get_spiel(name=spielname)[0][3]
